...
let alumniRealtimeChannel = null;
...
async function logoutAdmin(){
    ...
    try{
        ...
        if(alumniRealtimeChannel){

            await supabaseClient
                .removeChannel(
                    alumniRealtimeChannel
                );
...
async function handleAlumniRealtime(
    payload
){
                    ...
                    ([method,data]) => {
                        ...
                        return `
                            ...
                            <tr>
                                ...
                                <td class="amount amount-approved">
                                    ${formatMoney(
                                        data.amount
                                    )}
                                </td>
...
function getCategoryName(x){
    ...
    if(category === "EX_1986_2023"){

        return "SSC 1986–2023";

    }

    if(category === "EX_2024_2026"){

        return "SSC 2024–2026";

    }

    if(category === "CLASS_6_7"){
...
function renderBatchSummary(
    ...
    approvedRows.forEach(x => {
        ...
        batches[batch].approved++;

        batches[batch].amount +=
            Number(
                value(
                    x,
                    "payment_amount"
...
console.log(
    "LIVE Batch Analytics: ACTIVE"
);

console.log(
    "LIVE Category Analytics: ACTIVE"
);

console.log(
    "LIVE Approved Amount Analytics: ACTIVE"
);

console.log(
    "Supabase Alumni Realtime: ACTIVE"
);
